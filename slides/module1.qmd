...
::: Proof
1. Prove that $B =  ( B\cap A ) \cup  ( B\cap A^{c})$; 

2. Since we know that $A \subset B$, then $B \cap A = A$ (prove it!). Hence
   the equation above is
   $$B = ( B\cap A ) \cup  ( B\cap A^{c}) = A \cup ( B \cap A^{c})$$ 

3. Since $A$ and $B \cap A^{c}$ are disjoint (why?), Axiom 3
   says $\P ( B )  =  \P ( A ) + \P ( B\cap A^{c})$

4. Axiom 2 ensures that $\P ( B\cap A^{c}) \ge 0$. Thus,
   the last equation satisfies
...
### $\P ( A\cup B ) =\P ( A ) +\P( B ) -\P ( A\cap B )$
::: Proof
1. First prove that $A\cup B = A\cup  ( B\cap A^{c} )$. Since $A$ and 
   $B\cap A^{c}$ are disjoint events, Axiom 3 implies that  
   $$\P ( A\cup B ) =\P ( A ) +\P ( B \cap A^{c} )$$
3. "Slice" $B$ into the part it shares with $A$ and 
   the rest: $B  =  ( B\cap A ) \cup  ( B\cap A^c )$, where the 
   events on the right-hand side are disjoint. Apply 
   Axiom 3 to get 
   $\P ( B) = \P ( B\cap A ) +\P ( B\cap A^c )$

4. The last equation can be re-written as
   $\P ( B\cap A^c ) = \P ( B)  -  \P ( B\cap A )$
   
5. Replace this expression for $\P( B\cap A^c )$
   in 2. to get
   $$\P ( A\cup B ) =\P ( A ) +\P ( B \cap A^{c} ) = 
   \P ( A ) + \P ( B)  -  \P ( B\cap A )$$
:::
...
- Ven diagrams are not proofs. They are sometimes 
useful, but a diagram is not a proof or a logical
argument. 
